...
nobel_living_science <- nobel_living_science %>%
   mutate(born_country_us = if_else(bron_country == "USA", "USA" , "Other"))
```
...
nobel_living_science <- nobel_living_science %>%
   mutate                                                      (born_country_us = if_else(bron_country == "USA", "USA" , "Other"))
nobel_living_science%>%ggplot(aes(x = country_us,y=bron_contry_us , fill=category))
geom_bar(stat ="identity", poition = "dodge" ,orientation = "horizontl")
```
...
```{r}
nobel_living_science %>%
fliter(bron_country_us=="other" ,conutry_us=="USA")%>%cnunt("bron_country")%>%
  arrange(desc(n))
```
